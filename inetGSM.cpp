...
int InetGSM::openmail(char* server, char* loginbase64, char* passbase64, char* from, char* to, char* subj, char* mailBody)
{
     boolean connected=false;
     int n_of_at=3;
     char end_c[2];
  ...
  /*    while(n_of_at<3) {
    ...
    /*  if(!connected) return 0; */
	 ...
	 gsm.SimpleWrite("\n");
	 gsm.SimpleWrite("Date: ");
     gsm.SimpleWrite("Fri, 13 Nov 2015 15:41:47 +0700 (WIT)");
	 gsm.SimpleWrite("\n");
	 gsm.SimpleWrite("From: ");
     gsm.SimpleWrite(from);
	 gsm.SimpleWrite("\n");
...
// int InetGSM::sendmailWithAttachment(char* server, char* loginbase64, char* passbase64, char* from, char* to, char* subj, char* mailBody){
	 // boolean connected=false;
     // int n_of_at=3;
     // char end_c[2];
     // end_c[0]=0x1a;
